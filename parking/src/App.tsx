...
import type { FilterState, ParkingPlace, SortOption, SortOrigin } from './types/parking'
...
export default function App() {
  ...
  const { places, loading, error, search } = useParkingSearch()
    ...
    <div className="app">
      <header className="header">
        <div className="header-main">
          ...
          <span className="subtitle">北台三都路外停車場即時車位</span>
        </div>
        {user ? (
          <button className="auth-btn" onClick={() => void logout()} title="登出">
